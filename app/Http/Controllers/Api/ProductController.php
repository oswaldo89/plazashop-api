...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($product->save()) {
            ...
            Slack::send('Nuevo masacota agregada: ' . '<br/>' . '<b>Nombre:</b> ' . $product->nombre . '<br/>' . '<b>Descripcion:</b> ' . $product->descripcion );
        } else {
            $result['status'] = false;
    ...
    public function updateProduct(Request $request)
    {
        ...
        if ($product->update()) {
            ...
            Slack::send('Mascota modificada: ' . '<br/>' . '<b>Nombre:</b> ' . $product->nombre . '<br/>' . '<b>Descripcion:</b> ' . $product->descripcion );
        } else {
            $result['status'] = false;
